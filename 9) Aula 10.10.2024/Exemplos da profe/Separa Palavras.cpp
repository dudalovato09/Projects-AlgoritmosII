...
main(){
 char nome1[50],//nome lido
      nome2[50],//nome que será manipulado
      diferenca[50]="";//receberá cada parte do nome
 char *resultado;//receberá resultado da função strstr
 int i, //controle do for
     repete=1, //controla a repetição do while
     conta;//conta a quantidade de palavras
 do{
 ...
 while(repete)
 {
    ...
    {
        printf("\n %s", diferenca);//mostra a parte do nome
